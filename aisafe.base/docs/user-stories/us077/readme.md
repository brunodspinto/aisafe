...
The test suite comprises **2 US077-specific deactivation tests** added to `PilotTest` (18 methods total, shared with US075) + **12 integration tests** (`RemovePilotControllerTest`) = **14 automated tests**, all passing.
